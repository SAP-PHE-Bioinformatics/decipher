...
deciPHEr_QC=$(sbatch --dependency=afterok:${JOBID_BCL} --job-name deciPHEr_QC --mem 100G --ntasks 16 --time 960:00:00 -D /scratch/decipher/$folder --wrap "snakemake -j 16 --use-conda --configfile /scratch/decipher/$folder/config.yaml --snakefile /phe/tools/decipher/Snakefile_deciPHEr_QC " )
